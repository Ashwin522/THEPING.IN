...
public function getNotifications($data,$limit) {
	...
	if(mysqli_num_rows($query) == 0) {
		echo "You have no notitifications!";
		return;
	}
...
if($count > $limit)
	...
	$return_string .="<input type='hidden' class='noMoreDropdownData' value='true'> <p style='text-align: centre;'>No more messages to load!</p>";
